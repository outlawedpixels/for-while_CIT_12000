...
var userHits = Number(prompt("A dragon stumbles across your path! How many hits are you going to attempt?"))

for(var userHealth = 5, dragHealth = 10; userHealth > 0 && dragHealth > 0;)
  
  {
    
    userHits = Number(prompt("How many hits are you going to attempt this time?"))
